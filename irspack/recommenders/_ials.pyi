...
class IALSLearningConfig():
    ...
    def __init__(self, arg0: int, arg1: float, arg2: float, arg3: float, arg4: int, arg5: int, arg6: bool, arg7: int) -> None: ...
...
class IALSLearningConfigBuilder():
    ...
    def set_max_cg_step(self, arg0: int) -> IALSLearningConfigBuilder: ...
...
class IALSTrainer():
    def __getstate__(self) -> tuple: ...
    def __init__(self, arg0: IALSLearningConfig, arg1: scipy.sparse.csr_matrix[float32]) -> None: ...
    def __setstate__(self, arg0: tuple) -> None: ...
    def step(self) -> None: ...
    def transform_item(self, arg0: scipy.sparse.csr_matrix[float32]) -> numpy.ndarray[float32, _Shape[m, n]]: ...
    def transform_user(self, arg0: scipy.sparse.csr_matrix[float32]) -> numpy.ndarray[float32, _Shape[m, n]]: ...
