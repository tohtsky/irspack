...
class P3alphaComputer():
    def __init__(self, X: scipy.sparse.csr_matrix[float64], alpha: float = 0, n_thread: int) -> None: ...
...
class TverskyIndexComputer():
    def __init__(self, X: scipy.sparse.csr_matrix[float64], shrinkage: float, alpha: float, beta: float, n_thread: int) -> None: ...
    def compute_similarity(self, arg0: scipy.sparse.csr_matrix[float64], arg1: int) -> scipy.sparse.csr_matrix[float64]: ...
    pass
