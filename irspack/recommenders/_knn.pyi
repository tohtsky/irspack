...
class AsymmetricSimilarityComputer():
    def __init__(self, X: scipy.sparse.csr_matrix[float64], shrinkage: float, alpha: float, n_thread: int = 1, max_chunk_size: int = 128) -> None: ...
...
class CosineSimilarityComputer():
    def __init__(self, X: scipy.sparse.csr_matrix[float64], shrinkage: float, normalize: bool, n_thread: int = 1, max_chunk_size: int = 128) -> None: ...
    def compute_similarity(self, arg0: scipy.sparse.csr_matrix[float64], arg1: int) -> scipy.sparse.csr_matrix[float64]: ...
    pass
class JaccardSimilarityComputer():
    def __init__(self, X: scipy.sparse.csr_matrix[float64], shrinkage: float, n_thread: int = 1, max_chunk_size: int = 128) -> None: ...
    def compute_similarity(self, arg0: scipy.sparse.csr_matrix[float64], arg1: int) -> scipy.sparse.csr_matrix[float64]: ...
    pass
...
class TverskyIndexComputer():
    def __init__(self, X: scipy.sparse.csr_matrix[float64], shrinkage: float, alpha: float, beta: float, n_thread: int = 1, max_chunk_size: int = 128) -> None: ...
    def compute_similarity(self, arg0: scipy.sparse.csr_matrix[float64], arg1: int) -> scipy.sparse.csr_matrix[float64]: ...
    pass
