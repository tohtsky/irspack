...
from irspack.optimizers import (  # BPRFMOptimizer, #requires lightFM; MultVAEOptimizer, #requires jax & haiku & optax
...
if __name__ == "__main__":
    ...
    for optimizer_class, n_trials in test_configs:
        ...
        (best_param, validation_results) = optimizer.optimize(n_trials=n_trials)
